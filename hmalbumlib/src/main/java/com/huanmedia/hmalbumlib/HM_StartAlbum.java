...
import com.huanmedia.hmalbumlib.ui.HM_MultiAlbumActivity;
...
public class HM_StartAlbum {
    ...
    public static final String EXTRA_ALBUM_TARGETPATH = Extar + "targetPath";//是否裁剪
    ...
    private HM_StartAlbum(Context mContext, Bulide bulide) {
        ...
        if (bulide.targetPath !=null) {
            intent.putExtra(EXTRA_ALBUM_TARGETPATH, bulide.targetPath);
        }
    ...
    public static class Bulide {
        ...
        public Bulide setTargetPath(File targetPath) {
