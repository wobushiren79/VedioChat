...
import com.huanmedia.hmalbumlib.ui.HM_AlbumCorpActivity;
...
public class HM_StartCorp {
    ...
    public static final String EXTRA_CORP_CHOOSE_TARGETPATH = Extar + "targetPath";
    ...
    private HM_StartCorp(Context mContext, Bulide bulide) {
        ...
        if (bulide.targetPaht != null) {
            intent.putExtra(EXTRA_CORP_CHOOSE_TARGETPATH, bulide.targetPaht);
        }

        if (bulide.chooseImage != null) {
            intent.putExtra(EXTRA_CORP_CHOOSE_DATA, bulide.chooseImage);
    ...
    public static class Bulide {
        ...
        public Bulide setTargetPaht(File targetPaht) {
