...
import com.huanmedia.hmalbumlib.ui.adapter.HM_PhotoPagerAdapter;
import com.huanmedia.hmalbumlib.ui.widget.HM_HackyViewPager;

import java.util.ArrayList;
import java.util.Locale;

public class HM_PhotoPagerActivity extends BaseActivity implements ViewPager.OnPageChangeListener, HM_PhotoPagerAdapter.OnPhotoListener, View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.hm_album_photo_page;
    }
    @Override
    ...
    private void setToolbar() {
        ...
        toolbar.setBackgroundColor(ContextCompat.getColor(this,R.color.hm_overlay));
        setSupportActionBar(toolbar);
        mActionRight.setVisibility(View.VISIBLE);
        mActionRight.setText(String.format(Locale.getDefault(), "确定(%d)", chooseImage.size()));
        mActionRight.setTextColor(ContextCompat.getColor(this, R.color.hm_text_hint));
        mActionLayout.getBackground().mutate().setAlpha(200);
