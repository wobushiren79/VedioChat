...
import com.huanmedia.hmalbumlib.HM_SystemDialogUtils;
...
import com.huanmedia.hmalbumlib.extar.namegenerator.HM_Md5FileNameGenerator;
...
public class HM_AlbumCorpActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.hm_activity_album_corp;
    }
    ...
    protected void initData() {
        ...
        targetPath = (File) getIntent().getSerializableExtra(HM_StartCorp.EXTRA_CORP_CHOOSE_TARGETPATH);
        if (targetPath==null){
...
//                    .into(cropImageView);
    ...
    public Uri createSaveUri() {
            return Uri.fromFile(new File(targetPath, new HM_Md5FileNameGenerator().generate(System.currentTimeMillis()+"")+".jpeg"));
    }
