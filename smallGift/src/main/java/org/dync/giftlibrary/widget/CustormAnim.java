...
public class CustormAnim implements ICustormAnim {
    ...
    public AnimatorSet startAnim(final GiftFrameLayout giftFrameLayout, View rootView) {
        //礼物飞入
        giftFrameLayout.measure(View.MeasureSpec.UNSPECIFIED,View.MeasureSpec.UNSPECIFIED);
        ObjectAnimator flyFromLtoR2 = GiftAnimationUtil.createFlyFromLtoR(giftFrameLayout, -giftFrameLayout.getMeasuredWidth(), 0, 1000, new AccelerateInterpolator());
