...
//            FUManager.setCurrentItemByPosition(itemPosition);
    ...
    public void onProgressChanged(DiscreteSeekBar seekBar, int value, boolean fromUser) {
        ...
        if (i == R.id.color_level_seekbar) {
            FUManager.setColorLevel((float)value/seekBar.getMax());
        } else if (i == R.id.red_level_seekbar) {
            FUManager.setRedLevel((float)value/seekBar.getMax());
        } else if (i == R.id.face_shape_level_seekbar) {
            FUManager.setFaceShapeLevel((float)value/seekBar.getMax());
        } else if (i == R.id.cheek_thinning_seekbar) {
            FUManager.setCheekThinning((float)value/seekBar.getMax());
        } else if (i == R.id.eye_enlarging_seekbar) {
            FUManager.setEyeEnlarging((float)value/seekBar.getMax());
        }
    }
