package com.huanmedia.ilibray.utils.data.assist;
...
public class KeyguardLock {
    private static final String TAG = "KeyguardLock: %s";
    ...
    public boolean isKeyguardLocked() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
            Logger.e(TAG,"can not call isKeyguardLocked if SDK_INT < 16 ");
            return false;
        } else {
    ...
    public boolean isKeyguardSecure() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
            Logger.e(TAG, "can not call isKeyguardSecure if SDK_INT < 16 ");
            return false;
        } else {
