...
import com.huanmedia.ilibray.R;
...
public class GlideUtils {
     ...
     * @param errorid   错误
     */
    public void loadContextBitmap(Context context, Object path, ImageView imageView, int placeid, int errorid, boolean showGif) {
        if (!showGif) {
            GlideApp.with(context).load(path).placeholder(placeid).error(errorid)
                    .transition(withCrossFade()).into(imageView);
        } else {
            GlideApp.with(context).asGif().load(path).placeholder(placeid).error(errorid)
                    .transition(withCrossFade()).into(imageView);
        }
    }

    public void loadContextBitmap(Context context, Object path, ImageView imageView, boolean showGif) {
        loadContextBitmap(context, path, imageView, R.drawable.bg_logot, R.drawable.bg_logot, showGif);
    }
     ...
     * @param errorid
     */
    public void loadFragmentBitmap(Fragment fragment, Object path, ImageView imageView, int placeid, int errorid, boolean showGif) {
        if (!showGif) {
            GlideApp.with(fragment).load(path).transition(withCrossFade()).placeholder(placeid).error(errorid).into(imageView);
        } else {
            GlideApp.with(fragment).asGif().load(path)
                    .placeholder(placeid).error(errorid)
                    .transition(withCrossFade()).into(imageView);
        }
    }

    public void loadFragmentBitmap(Fragment fragment, Object path, ImageView imageView, boolean showGif) {
        loadFragmentBitmap(fragment, path, imageView, R.drawable.bg_logot, R.drawable.bg_logot, showGif);
    }

    public void loadBitmapNoAnim(Fragment fragment, Object path, ImageView imageView) {
        GlideApp.with(fragment).asBitmap().load(path).placeholder(R.drawable.bg_logot).error(R.drawable.bg_logot).into(imageView);
    }
    public void loadBitmapNoAnim(Context context, Object path, ImageView imageView) {
        GlideApp.with(context).asBitmap().load(path).placeholder(R.drawable.bg_logot).error(R.drawable.bg_logot).into(imageView);
    }

    public void loadBitmapNoAnim(Activity activity, Object path, ImageView imageView) {
        GlideApp.with(activity).asBitmap().load(path).placeholder(R.drawable.bg_logot).error(R.drawable.bg_logot)
                .into(imageView);
    }
    //-----------------------圆角图片----------------------
    ...
    public void loadContextRoundBitmap(Context context, Object path, ImageView imageView, RoundedCornersTransformation transformation) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadfragmentRoundBitmap(Fragment fragment, Object path, ImageView imageView, RoundedCornersTransformation transformation) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadContextBlurBitmap(Context context, Object path, ImageView imageView, int radius) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadFragmentBlurBitmap(Fragment fragment, Object path, ImageView imageView, int radius) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadContextRotateBitmap(Context context, Object path, ImageView imageView, Float rotateRotationAngle) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadFragmentRotateBitmap(Fragment fragment, Object path, ImageView imageView, Float rotateRotationAngle) {
