...
public final class StorageUtil {
	...
	return getIndividualCacheDirectory(context,cacheDir,true);
	}
	/**
	 * 在默认缓存目录下创建目录：（eg:/Android/data/"packagename"/"cache/cacheDir"）
	 * 如果不存在SD卡则默认会使用eg:"/data/data/" + context.getPackageName() + "/cache/"cacheDir
	 */
	protected static File getIndividualCacheDirectory(Context context, String cacheDir,boolean isExternal) {
		File appCacheDir = getCacheDirectory(context,isExternal);
