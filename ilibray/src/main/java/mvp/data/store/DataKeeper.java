...
import com.huanmedia.ilibray.utils.data.cipher.Cipher;
...
public class DataKeeper {
    ...
    public static final String USERCONFIG  = "userConfig.pre";
    private static final String TAG  = DataKeeper.class.getSimpleName();

//    public static String getForUserConfio(long id) {
//        return String.valueOf(id)+"-"+USERCONFIG;
//    }
