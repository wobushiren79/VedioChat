...
public class PhotosItemDragAndSwipeCallback extends ItemTouchHelper.Callback  {
...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
    ...
    public PhotosItemDragAndSwipeCallback(BaseItemDraggableAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    private boolean isViewCreateByAdapter(RecyclerView.ViewHolder viewHolder) {
        ...
        return type == BaseQuickAdapter.HEADER_VIEW || type == BaseQuickAdapter.LOADING_VIEW
                || type == BaseQuickAdapter.FOOTER_VIEW || type == BaseQuickAdapter.EMPTY_VIEW||type==1742;
    }
}
