...
public class UserManager {
    ...
    private static final String KEY_USER_OLD_PHONE = "key_user_old_phone";
    ...
    public void saveUser(UserEntity currentUser) {
        ...
        setOldUserPhone(mCurrentUser.getMobile());
    }
    ...
    public String getOldUserPhone() {
        return mDataKeeper.get(KEY_USER_OLD_PHONE, "");
    }

    public void setOldUserPhone(String oldUserPhone) {
        mDataKeeper.put(KEY_USER_OLD_PHONE, oldUserPhone);
    }
