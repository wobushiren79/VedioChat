...
public abstract class BasePopupWindow {
    ...
    public BasePopupWindow(Context context, int layoutRes, int w, int h) {
        mContext = context;
        mView = LayoutInflater.from(context).inflate(layoutRes, null, false);
        initView();
        initData();
        mInstance = new PopupWindow(mView, w, h, true);
        initWindow();
    }
    ...
    public void show(View anchor, LayoutGravity layoutGravity, int xmerge, int ymerge) {
    ...
    public static class LayoutGravity {
        ...
        static final int ALIGN_BOTTOM = 0x8;
