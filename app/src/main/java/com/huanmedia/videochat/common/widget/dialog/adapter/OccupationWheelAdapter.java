 ...
 * 兴趣、家乡、行业
 */
public class OccupationWheelAdapter extends AbstractWheelAdapter {
        private final LayoutInflater inft;
        List<ItemMenuEntity> entities =new ArrayList<>();
        public OccupationWheelAdapter(Context context) {
    ...
    public OccupationWheelAdapter(Context context, List<? extends ItemMenuEntity> entities) {
        inft = LayoutInflater.from(context);
