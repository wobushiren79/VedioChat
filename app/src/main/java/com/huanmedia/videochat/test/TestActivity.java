    ...
    public void onClickView(View view) {
        switch (view.getId()) {
            case R.id.bt_test_1:
                ...
                listData.add("http://flashmedia.eastday.com/newdate/news/2016-11/shznews1125-19.mp4");
                ...
                getNavigator().navtoMediaPlay(this, listData,0);
                break;
            case R.id.bt_test_2:
                getNavigator().navtoMediaUpLoad(this,new ArrayList<>());
                break;
            case R.id.bt_test_3:
                break;
        }
