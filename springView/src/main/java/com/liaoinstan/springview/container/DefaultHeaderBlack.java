 ...
 */
public class DefaultHeaderBlack extends BaseHeader {
    ...
    public DefaultHeaderBlack(Context context){
        this(context, R.drawable.progress_small,R.drawable.arrow);
    }

    public DefaultHeaderBlack(Context context, int rotationSrc, int arrowSrc){
    ...
    public View getView(LayoutInflater inflater,ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.black_headerview, viewGroup, true);
        headerTitle = (TextView) view.findViewById(R.id.default_header_black_title);
        headerTime = (TextView) view.findViewById(R.id.default_header_black_time);
        headerArrow = (ImageView) view.findViewById(R.id.default_header_black_arrow);
        headerProgressbar = (ProgressBar) view.findViewById(R.id.default_header_black_progressbar);
    ...
    public int getDragLimitHeight(View rootView) {
        return rootView.findViewById(R.id.black_headerview_content).getMeasuredHeight();
    }
    @Override
...
//        return rootView.findViewById(R.id.black_headerview_content).getMeasuredHeight()-100;
//    }
    @Override
